...
command! -nargs=0 Vim2ChromeReplaseAllNotActivateVim call vim2browser#Vim2ChromeReplaseAllNotActivateVim() 
command! -nargs=0 Vim2ChromeAppendAllNotActivateVim call vim2browser#Vim2ChromeAppendAllNotActivateVim() 
command! -nargs=0 Vim2ChromeReplaseSelectedNotActivateVim call vim2browser#Vim2ChromeReplaseSelectedNotActivateVim() 
command! -nargs=0 Vim2ChromeAppendSelectedNotActivateVim call vim2browser#Vim2ChromeAppendSelectedNotActivateVim() 
