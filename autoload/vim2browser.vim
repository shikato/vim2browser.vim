...
function! vim2browser#Vim2ChromeReplaseAll() 
  ...
  call system("osascript -l JavaScript " . s:scriptsDir . "/../jxa/vim2chrome.js " . s:TYPE_REPLACE_ALL . " " . s:vimAppName . " > /dev/null 2>&1") 
endfunction 

function! vim2browser#Vim2ChromeReplaseSelected() 
  call s:SaveShareTextList(s:GetSelectedTextList())
  call system("osascript -l JavaScript " . s:scriptsDir . "/../jxa/vim2chrome.js " . s:TYPE_REPLACE_SELECTED . " "  . s:vimAppName . " > /dev/null 2>&1") 
endfunction 

function! vim2browser#Vim2ChromeAppendAll() 
  call s:SaveShareTextList(s:GetAllTextList())
  call system("osascript -l JavaScript " . s:scriptsDir . "/../jxa/vim2chrome.js " . s:TYPE_APPEND_ALL . " "  . s:vimAppName . " > /dev/null 2>&1") 
endfunction 

function! vim2browser#Vim2ChromeAppendSelected() 
  call s:SaveShareTextList(s:GetSelectedTextList())
  call system("osascript -l JavaScript " . s:scriptsDir . "/../jxa/vim2chrome.js " . s:TYPE_APPEND_SELECTED . " "  . s:vimAppName . " > /dev/null 2>&1") 
endfunction 
